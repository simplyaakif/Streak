...
<?php $__env->startPush('scripts'); ?>
    ...
    params: {
<!--[if BLOCK]><![endif]--><?php if($attributes['max-width']): ?>
      max_width: <?php echo e($attributes['max-width']); ?>,
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<!--[if BLOCK]><![endif]--><?php if($attributes['max-height']): ?>
...
window.Livewire.find('<?php echo e($_instance->getId()); ?>').addMedia(response.media)
    },
...
window.Livewire.find('<?php echo e($_instance->getId()); ?>').removeMedia(response.media)
        } else {
window.Livewire.find('<?php echo e($_instance->getId()); ?>').removeMedia(file)
        }
    },
    init: function () {
        document.addEventListener("livewire:init", () => {
            let files = window.Livewire.find('<?php echo e($_instance->getId()); ?>').mediaCollections["<?php echo e($attributes['collection-name'] ?? 'default'); ?>"]
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/muhammadaakifraza/Herd/Portal/resources/views/components/dropzone.blade.php ENDPATH**/ ?>