...
} elseif ($_instance->childHasBeenRendered('Frt5636')) {
    $componentId = $_instance->getRenderedChildComponentId('Frt5636');
    $componentTag = $_instance->getRenderedChildComponentTagName('Frt5636');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Frt5636');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('Frt5636', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('UscuU8b')) {
    $componentId = $_instance->getRenderedChildComponentId('UscuU8b');
    $componentTag = $_instance->getRenderedChildComponentTagName('UscuU8b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UscuU8b');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('UscuU8b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH F:\Aakif Work\Systems Developments\streakz\vendor\filament\filament\src\/../resources/views/components/layouts/app.blade.php ENDPATH**/ ?>