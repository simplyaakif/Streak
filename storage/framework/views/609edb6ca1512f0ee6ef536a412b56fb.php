...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.ph-section-header','data' => ['title' => 'Create Query','subtitle' => 'Create a new query in system']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Create Query','subtitle' => 'Create a new query in system']); ?>
...
[$__name, $__params] = $__split('query.create');

$__html = app('livewire')->mount($__name, $__params, 'lw-3782661828-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhammadaakifraza/Herd/Portal/resources/views/admin/query/create.blade.php ENDPATH**/ ?>