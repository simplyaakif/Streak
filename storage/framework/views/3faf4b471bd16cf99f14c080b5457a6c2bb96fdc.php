...
} elseif ($_instance->childHasBeenRendered('Clu52GI')) {
    $componentId = $_instance->getRenderedChildComponentId('Clu52GI');
    $componentTag = $_instance->getRenderedChildComponentTagName('Clu52GI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Clu52GI');
} else {
    $response = \Livewire\Livewire::mount('admin.filament.recovery.recovery-index', []);
    $html = $response->html();
    $_instance->logRenderedChild('Clu52GI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
