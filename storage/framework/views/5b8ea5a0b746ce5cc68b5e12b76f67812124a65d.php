...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.button.primary','data' => ['wire:click' => '$set(\'showModal\',true)']]); ?>
...
<?php endif; ?>
    <div class="mt-4">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.common.table','data' => ['class' => 'w-full']]); ?>
...
<?php endif; ?>
             ...
             <?php $__env->slot('body', null, []); ?> 
                <?php $__empty_1 = true; $__currentLoopData = $attendanceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date =>$record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="flex space-x-2">
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.icons.eye','data' => ['class' => 'w-5 h-5 text-gray-500','wire:click' => 'showAttendance(\''.e($date).'\')']]); ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.icons.edit','data' => ['class' => 'w-5 h-5 text-blue-500','wire:click' => '']]); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.common.table.cell','data' => ['colspan' => '3']]); ?>
<?php $component->withName('common.table.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
    ...
    <div>
        ...
        <?php if($showAttendanceModal): ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.modal.dialog','data' => ['maxWidth' => '3xl','wire:model' => 'showAttendanceModal']]); ?>
<?php $component->withName('modal.dialog'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['maxWidth' => '3xl','wire:model' => 'showAttendanceModal']); ?>
...
<?php endif; ?>
                         <?php $__env->endSlot(); ?>
                         <?php $__env->slot('body', null, []); ?> 
                            <?php $__empty_1 = true; $__currentLoopData = $attendanceRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.common.table.row','data' => []]); ?>
<?php $component->withName('common.table.row'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
                 ...
                 <?php $__env->slot('footer', null, []); ?> 
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.button.secondary','data' => ['wire:click' => '$set(\'showAttendanceModal\',false)']]); ?>
...
<?php endif; ?>
    ...
    <form wire:submit.prevent="submit">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.modal.dialog','data' => ['maxWidth' => '3xl','wire:model' => 'showModal']]); ?>
<?php $component->withName('modal.dialog'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['maxWidth' => '3xl','wire:model' => 'showModal']); ?>
             <?php $__env->slot('title', null, []); ?> 
...
<?php $component->withAttributes([]); ?>
                                    <div class="text-xs space-x-2">
                                        <?php $__currentLoopData = App\Models\StudentAttendance::STATUS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label for="status_<?php echo e($student->id); ?>_<?php echo e($status); ?>">
                                                <input type="radio" id="status_<?php echo e($student->id); ?>_<?php echo e($status); ?>"
                                                       ...
                                                       wire:model.defer="statuses.<?php echo e($student->id); ?>"
...
<?php /**PATH E:\Aakif Work\Systems Developments\streakz\resources\views/livewire/admin/student-attendance.blade.php ENDPATH**/ ?>