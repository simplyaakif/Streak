...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.logo-ace','data' => ['class' => 'h-12']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin.menu','data' => []] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH F:\Aakif Work\Systems Developments\streakz\resources\views/components/nav.blade.php ENDPATH**/ ?>