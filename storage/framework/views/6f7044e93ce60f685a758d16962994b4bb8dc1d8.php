...
} elseif ($_instance->childHasBeenRendered('w0ILLFO')) {
    $componentId = $_instance->getRenderedChildComponentId('w0ILLFO');
    $componentTag = $_instance->getRenderedChildComponentTagName('w0ILLFO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w0ILLFO');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-spotlight');
    $html = $response->html();
    $_instance->logRenderedChild('w0ILLFO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\Aakif Work\Systems Developments\streakz\resources\views/layouts/admin.blade.php ENDPATH**/ ?>