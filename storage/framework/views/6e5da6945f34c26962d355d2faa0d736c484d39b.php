<svg <?php echo e($attributes); ?> viewBox="0 0 24 24" fill="none"
    ...
    <path d="M12 5.49001V20.49" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
          stroke-linejoin="round"/>
    <path d="M7.75 8.49H5.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
          stroke-linejoin="round"/>
    <path d="M8.5 11.49H5.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
          stroke-linejoin="round"/>
</svg>
<?php /**PATH F:\Aakif Work\Systems Developments\streakz\resources\views/components/icons/book.blade.php ENDPATH**/ ?>