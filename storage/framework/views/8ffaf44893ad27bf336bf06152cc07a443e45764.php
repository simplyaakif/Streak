...
<div x-data="{ show: <?php if ((object) ('validationAlert') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('validationAlert'->value()); ?>')<?php echo e('validationAlert'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('validationAlert'); ?>')<?php endif; ?> }" aria-live="assertive" class="fixed inset-0 z-10 flex items-end
px-4 py-6
pointer-events-none
...
<?php /**PATH E:\Aakif Work\Systems Developments\streakz\resources\views/components/common/validation-alert.blade.php ENDPATH**/ ?>