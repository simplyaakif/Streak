...
{{--                    <img class="hidden lg:block h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-500-mark-white-text.svg" alt="Workflow">--}}
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                       ...
                       <x-student.nb-md-item route="{{route('student.discussions')}}">Discussions</x-student.nb-md-item>
                    </div>
                </div>
            </div>
            <div class="hidden sm:ml-6 sm:block">
                <div class="flex items-center">
                    <button type="button" class="bg-cyan-800 p-1 rounded-full text-cyan-100 hover:text-white
                    ...
                    <div x-data="{menu:false}"  class="ml-3 relative">
                        ...
                        ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
            ...
            <div class="-mr-2 flex sm:hidden">
                ...
                rounded-md
                text-gray-400
                hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
