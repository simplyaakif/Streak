...
@if($is_disabled)
 ...
 {{ $errors->has($error) ? 'border-red-300 bg-gray-200 disabled:cursor-not-allowed disabled:bg-gray-200 text-red-900 placeholder-red-300
...
@else
 ...
 {{ $errors->has($error) ? 'border-red-300  text-red-900 placeholder-red-300 focus:border-red-500
 focus:red-500' :
 'border-blue-gray-300 text-blue-gray-900 focus:border-blue-500 focus:ring-blue-500' }}
        rounded-md shadow-sm  sm:text-sm  ">
@endif
