...
<th
    {{ $attributes->merge(['class' => 'px-6 py-3 bg-cyan-50'])->only('class') }}
>
    @unless ($sortable)
        <span class="text-left text-xs leading-4 font-medium text-cyan-800 uppercase tracking-wider">{{ $slot }}</span>
    @else
