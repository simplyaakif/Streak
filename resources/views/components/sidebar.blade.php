                ...
                <div class="px-2 space-y-1">
                    ...
                    <x-admin.sidebar-nv-item label="Dashboard" route="{{route('admin.home')}}">
                        <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200"
                            ...
                            <path
                                d="M10.07 2.82L3.14001 8.37C2.36001 8.99 1.86001 10.3 2.03001 11.28L3.36001 19.24C3.60001 20.66 4.96001 21.81 6.40001 21.81H17.6C19.03 21.81 20.4 20.65 20.64 19.24L21.97 11.28C22.13 10.3 21.63 8.99 20.86 8.37L13.93 2.83C12.86 1.97 11.13 1.97 10.07 2.82Z"
                    ...
                    <x-admin.sidebar-dd-nav-item label="Query Management">
                        <x-slot name="icon">
                            ...
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z"
                                    stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    ...
                                    stroke="#A5F3FC" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round"/>
                                <path d="M18.7 16.25C19 17.33 19.84 18.17 20.92 18.47" stroke="#A5F3FC"
                                      stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M3.40997 22C3.40997 18.13 7.26 15 12 15C13.04 15 14.04 15.15 14.97 15.43"
                                      stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        ...
                        <x-slot name="icon">
                            ...
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 5.49001V20.49" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M7.75 8.49H5.5" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M8.5 11.49H5.5" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        ...
                        <x-slot name="icon">
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#A5F3FC" stroke-width="1.5" stroke-miterlimit="10"/>
                            </svg>
                        ...
                        <x-slot name="icon">
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#A5F3FC" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round"/>
                                <path d="M4.78 8.29999V12.7" stroke="#A5F3FC" stroke-width="1.5" stroke-miterlimit="10"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M16.2217 8.30029V12.7003" stroke="#A5F3FC" stroke-width="1.5"
                        ...
                        <x-slot name="icon">
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M17 21H7C3 21 2 20 2 16V8C2 4 3 3 7 3H17C21 3 22 4 22 8V16C22 20 21 21 17 21Z"
                                      stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M14 8H19" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M15 12H19" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M17 16H19" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path
                    ...
                    <x-admin.sidebar-dd-nav-item label="Asset Management">
                        <x-slot name="icon">
                            <svg class="mr-4 flex-shrink-0 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.17001 7.44L12 12.55L20.77 7.46997" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 21.61V12.54" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9.92999 2.48L4.59 5.45003C3.38 6.12003 2.39001 7.80001 2.39001 9.18001V14.83C2.39001 16.21 3.38 17.89 4.59 18.56L9.92999 21.53C11.07 22.16 12.94 22.16 14.08 21.53L19.42 18.56C20.63 17.89 21.62 16.21 21.62 14.83V9.18001C21.62 7.80001 20.63 6.12003 19.42 5.45003L14.08 2.48C12.93 1.84 11.07 1.84 9.92999 2.48Z" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M17 13.24V9.58002L7.51001 4.09998" stroke="#A5F3FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                ...
                <div class="mt-6 pt-6">
                    <div class="px-2 space-y-1">
                        ...
                        <x-admin.sidebar-nv-item label="Settings" route="{{route('admin.students.index')}}">
                            <svg class="mr-4 h-6 w-6 text-cyan-200" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
