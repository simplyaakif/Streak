    ...
    <form wire:submit.prevent="submit" class="mt-6 mb-6 space-y-8 divide-y divide-y-blue-gray-200">
        ...
        <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
            ...
            <div class=" sm:col-span-3  {{ $errors->has('account.title') ? 'text-red-500' : '' }}">
                ...
                <x-common.data-input-text error="account.title" label="title" name="title" wire:model="account.title" />
            ...
            <div class=" sm:col-span-3  {{ $errors->has('account.oversee_by_id') ? 'text-red-500' : '' }}">
                ...
                <x-common.data-input-select name="oversee_by_id" id="oversee_by_id" wire:model="account.oversee_by_id">
            ...
            <div class=" sm:col-span-3  {{ $errors->has('account.type') ? 'text-red-500' : '' }}">
                ...
                <x-common.data-input-select name="type" wire:model="account.type">
            ...
            <div class=" sm:col-span-3  {{ $errors->has('account.amount') ? 'text-red-500' : '' }}">
                ...
                <x-common.data-input-text error="account.amount" title="amount" name="amount" wire:model="account.amount"/>
                <div class="validation-message">
