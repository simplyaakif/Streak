<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('query.name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="name" id="name" required wire:model="query.name">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('query.mobile') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="mobile" id="mobile" required wire:model="query.mobile">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('query.email') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="email" name="email" id="email" wire:model="query.email">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('query.address') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="address" id="address" wire:model="query.address" rows="4"></textarea>
        <div class="validation-message">
